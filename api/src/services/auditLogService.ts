...
export enum AuditAction {
  ...
  // Iteración 1: Aportes, presupuesto, gastos, documentos
  CONTRIBUTION_CREATED = 'CONTRIBUTION_CREATED',
  CONTRIBUTION_UPDATED = 'CONTRIBUTION_UPDATED',
  CONTRIBUTION_PAID = 'CONTRIBUTION_PAID',
  CONTRIBUTION_INTIMATION_SENT = 'CONTRIBUTION_INTIMATION_SENT',
  BUDGET_ITEM_CREATED = 'BUDGET_ITEM_CREATED',
  BUDGET_ITEM_UPDATED = 'BUDGET_ITEM_UPDATED',
  CASHFLOW_PLAN_CREATED = 'CASHFLOW_PLAN_CREATED',
  EXPENSE_CREATED = 'EXPENSE_CREATED',
  EXPENSE_UPDATED = 'EXPENSE_UPDATED',
  EXPENSE_PAID = 'EXPENSE_PAID',
  FIDUCIARY_ACCOUNT_CREATED = 'FIDUCIARY_ACCOUNT_CREATED',
  BANK_MOVEMENT_CREATED = 'BANK_MOVEMENT_CREATED',
